export const imgPresident = [
  {
    ...
    'indice': {
      'tip1': 'L\'espérance c\'est le premier risque, c\'est le risque des risques.',
      'tip2': 'Il faut des jeunes Français qui aient envie de devenir milliardaires',
      'tip3': 'Si j\'étais chômeur, je n\'attendrais pas tout de l\'autre, j\'essaierais de me battre d\'abord.',
      'tip4': 'Nous sommes une nation de citoyens solidaires. Nous avons besoin les uns des autres. On s\'en sortira ensemble'
    }
  },
  {
    ...
    'indice': {
      'tip1': 'Si vous êtes en colère venez voter. Le principal c\'est d\'aller voter et de ne pas attendre le lendemain du vote pour protester.',
      'tip2': 'Aujourd\'hui sur cette terre du nord, le soleil s\'appelle le Louvre',
      'tip3': 'Je suis le président des bisous',
      'tip4': 'Ceux qui racontent l\'histoire sont beaucoup plus aimés que ceux qui font l\'histoire'
    }
  },
  {
    ...
    'indice': {
      'tip1': 'Il n\'y a pas de fatalité pour celui qui veut bien oser.',
      'tip2': 'Ce qui fait la crédibilité d\'une ambition, c\'est le prix personnel qu\'on est prêt à payer',
      'tip3': 'Il n\'y a pas de fatalité pour celui qui veut bien oser',
      'tip4': 'Les socialistes proposent de travailler moins. Moi, je propose de gagner plus'
    }
  },
  {
    'name': 'Jacques Chirac',
  ...
  },
  {
    ...
    'indice': {
      'tip1': 'Le plus long mandat',
      'tip2': 'C\'est blesser un peuple au plus profond de lui- même que de l\'atteindre dans sa culture et sa langue',
      'tip3': 'Un dictateur n\'a pas de concurrent à sa taille tant que le peuple ne relève pas le défi',
      'tip4': 'On n\'apprend rien par la parole, mais tout par l\'exemple.'
    }
  },
  {
    ...
    'indice': {
      'tip1': 'Pendant mon septennat, j’ai été amoureux de 17 millions de Françaises.',
      'tip2': 'La prison, c\'est la privation de la liberté d\'aller et venir, et rien d\'autre',
      'tip3': 'Je ne serai pas un Président-candidat, mais un citoyen-candidat',
      'tip4': 'Il faut laisser les choses basses mourir de leur propre poison'
    }
  },
  {
    ...
    'indice': {
      'tip1': 'Directeur général de la banque Rothschild',
      'tip2': 'Dans la vie des nations alternent la grandeur et la médiocrité',
      'tip3': 'Chaque problème résolu en fait naître d\'autres, en général plus difficiles',
      'tip4': 'Création d\'un centre d\'art contemporain à Paris'
    }
  },
  {
    ...
    'indice': {
      ...
      'tip4': 'La fin de l\'espoir est le commencement de la mort'
    }
  },
  {
    'name': 'René Coty',
    ...
    'indice': {
      'tip1': 'Élu président grâce à sa prostate',
      'tip2': 'Président de l\'Union parlementaire européenne',
      'tip3': 'Il prête serment d\'avocat et s\'inscrit au barreau du Havre',
      'tip4': 'C\'est notre RAÏS à nous'
    }
  },
  {
    'name': 'Vincent Auriol',
    ...
    'indice': {
      'tip1': 'Je regrette ceux qui voudraient faire de la présidence de la République une magistrature passive, silencieuse, de pure représentation.',
      'tip2': 'On ne peut pas fonder la prospérité des uns sur la misère des autres',
      'tip3': 'Il représente la France à la Conférence monétaire et financière de Bretton Woods',
      'tip4': 'Il est l\'un des quatre- vingts parlementaires à refuser de voter les pleins pouvoirs au maréchal Pétain, le 10 juillet 1940'
    }
  },
  {
    'name': 'Albert Lebrun',
    ...
    'indice': {
      'tip1': 'Resta légalement président pendant toute la durée de la guerre',
      'tip2': 'Ministre des Colonies, et brièvement ministre de la Guerre',
      'tip3': 'Victoire du Front populaire aux élections législatives',
      'tip4': 'Une particularité physique faisait que des larmes coulaient de ses yeux plus facilement que chez d\'autres personnes'
    }
  },
  {
    'name': 'Paul Doumer',
    ...
    'indice': {
      'tip1': 'Il est assassiné à Paris par Paul Gorgulov, émigré russe souffrant de troubles mentaux',
      'tip2': 'La femme est une page blanche sur laquelle l\'époux écrit à son gré',
      'tip3': 'Il devient bachelier grâce aux cours du soir du Conservatoire des Arts et métiers',
      'tip4': 'Il est initié franc-maçon par la loge parisienne l\'Union fraternelle, dont il devient compagnon et maître l\'année suivante'
    }
  },
  {
    ...
    'indice': {
      'tip1': 'Premier président protestant',
      'tip2': 'Il se déclare partisan d\'une politique de fermeté vis- à - vis de l\'Allemagne face au nationalisme renaissant',
      'tip3': 'Ministre de l\'Instruction publique et des Beaux- Arts',
      'tip4': 'Homme affable et courtois, il séduit depuis le début de sa carrière politique par sa bonhomie et son accent'
    }
  },
  {
    ...
    'indice': {
      'tip1': 'Premier socialiste à entrer dans le gouvernement',
      'tip2': 'Taisez-vous! Méfiez-vous! Les oreilles ennemies vous écoutent',
      'tip3': 'Exclu du parti socialiste pour avoir fait partie d\'un gouvernement "bourgeois"',
      'tip4': 'Pour diriger son secrétariat particulier, il nomme son fils âgé de 21 ans, ce qui lui vaut des accusations de népotisme'
    }
  },
  {
    'name': 'Paul Deschanel',
    ...
    'indice': {
      'tip1': 'Il fait une chute de train nocturne',
      'tip2': 'L\'esprit français, c\'est la raison en étincelles',
      'tip3': 'Vote pour l\'abolition de la peine capitale et de l\'échafaud',
      'tip4': 'Il est ovationné lorsqu’il prononce l’éloge funèbre de Jean Jaurès, assassiné par Raoul Villain'
    }
  },
  {
    ...
    'indice': {
      'tip1': 'Membre de l’Académie française',
      'tip2': 'Un banquier est toujours en liberté provisoire',
      'tip3': 'Il sauve le franc menacé par la spéculation',
      'tip4': 'Son mandat de chef de l\'État va évidemment être marqué par la Première Guerre mondiale'
    }
  },
  {
    ...
    'indice': {
      'tip1': 'Un garçon de café mécontent de sa politique extérieure lui tire la barbe',
      'tip2': 'La place est bonne. Malheureusement, il n\'y a pas d\'avancement',
      'tip3': 'Signature de la « Triple entente » entre la France, la Grande-Bretagne et la Russie',
      'tip4': 'Sous sa présidence, les forces de police sont modernisées, notamment par la création des « Brigades du Tigre »'
    }
  },
  {
    'name': 'Émile Loubet',
    ...
    'indice': {
      'tip1': 'Huitième président de la République française',
      'tip2': 'Agressé au champ de courses d\'Auteuil',
      'tip3': 'Gracie le capitaine Dreyfus',
      'tip4': 'Il convia l\'ensemble des maires de France à un banquet de 22 965 convives dans le jardin des Tuileries'
    }
  },
  {
    'name': 'Félix Faure',
    ...
    'indice': {
      'tip1': 'Il voulait être César, il ne fut que Pompée',
      'tip2': 'Incident de Fachoda entre la France et l\’Angleterre',
      'tip3': 'Il est révoqué par le gouvernement de Broglie',
      'tip4': 'C\'est à lui qu\'Émile Zola adresse, sa célèbre lettre ouverte « J\'accuse… ! »'
    }
  },
  {
    ...
    'indice': {
      'tip1': 'Sa présidence ne durera que six mois',
      'tip2': 'Nous ne concédons à aucun peuple le droit de nous forcer à combattre pour sa cause. Le sang des Français n\'appartient qu\'à la France',
      'tip3': 'Arrestation et condamnation du capitaine Dreyfus',
      'tip4': 'Il est le deuxième plus jeune président de l’histoire'
    }
  },
  {
    'name': 'Sadi Carnot',
    ...
    'indice': {
      'tip1': 'Assassiné par un anarchiste italien',
      'tip2': 'Le début de son mandat est marqué par le scandale de l\'affaire de Panama',
      'tip3': 'Sorti major de l\'École polytechnique, il entre à l\'École des Ponts et Chaussées',
      'tip4': 'Il repose au Panthéon, au côté de son illustre grand-père'
    }
  },
  {
    'name': 'Jules Grévy',
    ...
    'indice': {
      'tip1': 'Président Sagesse',
      'tip2': 'Il est contraint à la démission en raison du scandale des décorations impliquant son gendre',
      'tip3': 'le 14 juillet et La Marseillaise sont adoptés comme symboles',
      'tip4': 'Ses mots sont frappés en médaille'
    }
  },
  {
    ...
    'indice': {
      'tip1': 'Élu par une assemblée monarchiste',
      'tip2': 'La fièvre typhoïde est une maladie terrible: ou on en meurt, ou on en reste idiot. J\'en sais quelque chose: je l\'ai eue',
      'tip3': 'Que d\'eau, que d\'eau !',
      'tip4': 'J\'y suis, j\'y reste',
      'tip4': 'Maréchal de France'
    }
  },
  {
    'name': 'Adolphe Thiers',
  ...
  },
  {
    ...
    'indice': {
      'tip1': 'Le parti de l\'ordre a soutenu son élection',
      'tip2': 'Déguisé en ouvrier, il s\'évade et s\'installe à Londres',
      'tip3': 'Muni d\'un faux passeport américain, il parvient à se rendre en Suisse auprès de sa mère mourante',
      'tip4': 'Avec la complicité de chefs militaires, il prend le pouvoir'
    }
  }
];
